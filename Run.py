...
number=int("+8801893172448")

devoloper_info={
    
"Developer" :  'Shihab',
    "Number" : '+8801893172448',
    "Status" :  '24-ONLINE',
    "GitHub Url":  'MiM',
    "Facebook" :  'https://www.facebook.com/111Brokenheart',
    }
...
def main():
    ...
    space()
    dual("Hello bro,I am Shihab,I am an artificial intelligent,and welcome to our tool","y.mp3")
